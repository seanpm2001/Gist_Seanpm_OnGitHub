...
> * Digital photography (photo manipulation (basic) deepfaking (very basic) editing, filtering)

> * Drone photography (Tello drones, Mavic drones, etc.)

> * Photography with a camera (mobile, goPro, analog)

If we meet in public, don't be afraid to ask for help taking a picture, I take really good ones, and I don't take 1. I normally take about 5, so there are multiple good ones for you, and hopefully 1 that you find  to be perfect.
...
Gist version: `58 (Tuesday, August 4th 2020 at 8:10 pm)`

File type: `markdown (*.md)`

Character count (UNIX (LF) / Macintosh (CR)): 126,517 characters/bytes (126.51 Kilobytes)

Character count (WIndows (CR) (LF)): 130,272 characters/bytes (130.27 Kilobytes)

Word count: 0,021,900
...
Line count (including blank lines and compiler line): `003,761`
